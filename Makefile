...
GAMEPROJECTFILE =/home/marcin/data/Development/UnrealEngine/Udemy/Escape/Escape.uproject
...
Escape-Linux-Debug:
	 $(PROJECTBUILD) Escape Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

Escape-Linux-DebugGame:
	 $(PROJECTBUILD) Escape Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

Escape-Linux-Shipping:
	 $(PROJECTBUILD) Escape Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

Escape-Linux-Test:
	 $(PROJECTBUILD) Escape Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

Escape:
	 $(PROJECTBUILD) Escape Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

EscapeEditor-Linux-Debug:
	 $(PROJECTBUILD) EscapeEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

EscapeEditor-Linux-DebugGame:
	 $(PROJECTBUILD) EscapeEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

EscapeEditor-Linux-Shipping:
	 $(PROJECTBUILD) EscapeEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

EscapeEditor-Linux-Test:
	 $(PROJECTBUILD) EscapeEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

EscapeEditor:
	 $(PROJECTBUILD) EscapeEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
